<template>
  ...
  >
    ...
    <div :class="$style.AppMarkdown__Wrap">
      <textarea ref="editor" rows="5" cols="20"></textarea>
    </div>
  </div>
</template>
...
export default class AppMarkdown extends Vue {
  ...
  private mounted() {
    ...
    const options = {
      ...
      hideIcons: ['image', 'preview', 'side-by-side', 'fullscreen', 'table', 'guide'],
      status: false
    } as any
