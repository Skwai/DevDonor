<template>
  <div :class="$style.AuthLogin">
    ...
    <div v-else :class="$style.AuthLogin__Buttons">
      <AppBtn @click="login('facebook')" color="stroke">
        <svg slot="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path d="M9.032 23L9 13H5V9h4V6.5C9 2.789 11.298 1 14.61 1c1.585 0 2.948.118 3.345.17v3.88H15.66c-1.8 0-2.15.856-2.15 2.112V9h5.241l-2 4h-3.24v10H9.032z"/></svg>
        Sign in with Facebook
      </AppBtn>
      <AppBtn @click="login('google')" color="stroke">
