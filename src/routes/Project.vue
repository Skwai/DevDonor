  ...
  <AppPage class="Project" v-else>
    ...
    <div slot="sidebar">
      <div class="Project__Join">
        <AppContentBlock textAlign="center">
          <AppJoinProject :project="project" />
        </AppContentBlock>
      </div>
      <AppOrganizationPreview :organizationId="project.organization" />
      <AppProjectVolunteers :projectUserIds="project.volunteers" />
    </div>
  </AppPage>
</template>
...
import AppProjectVolunteers from '@/components/AppProjectVolunteers'
import AppOrganizationPreview from '@/components/AppOrganizationPreview'
import AppJoinProject from '@/components/AppJoinProject'

export default {
  components: {
    AppProjectVolunteers,
    AppOrganizationPreview,
    AppJoinProject
  },
